...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        TablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "DNI", "Edad", "Direccion", "Celular"
            }
        ));
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if (row == -1) {
            ...
            String cel = (String) TablaDatos.getValueAt(row, 5);
...
void listar() {
    ...
    try {
        ...
        while (rs.next()) {
            ...
            persona[5] = rs.getString("Celular");
    ...
    void Agregar() {
        ...
        try {
            if (nom.equals("") || dni.equals("") || edad.equals("") || direc.equals("") || cel.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);               
            } else {
                String sql =  "INSERT INTO cliente(Nombre, DNI, Edad, Direccion, Celular) values('" + nom + "','" + dni + "','" + edad + "','" +direc + "','" + cel + "')";
                con = cn.getConnection();
                st = con.createStatement();
...
void Modificar() {
    ...
    String sql = "update cliente set Nombre='" + nom + "',DNI='" + dni + "',Edad='" + edad + "',Direccion='" + direc + "',Celular='" + cel + "' where Id=" + id;
    try {
        if (!nom.isEmpty() && !dni.isEmpty() && !edad.isEmpty() && !direc.isEmpty() && !cel.isEmpty()) {
            con = cn.getConnection();
            st = con.createStatement();
            st.executeUpdate(sql);

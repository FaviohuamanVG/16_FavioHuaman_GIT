...
public class Principal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ID:");
        jLabel1.setMaximumSize(new java.awt.Dimension(15, 17));
        jLabel1.setMinimumSize(new java.awt.Dimension(15, 17));
        ...
        TablaDatos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "DNI", "Edad", "Direccion", "Apellidos"
            }
        ));
        ...
        jLabel8.setText("APLICACION - CRUD");
    ...
    private void TablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TablaDatosMouseClicked
        ...
        if (row == -1) {
            ...
            String ape = (String) TablaDatos.getValueAt(row, 5);
...
void listar() {
    ...
    void Agregar() {
        ...
        try {
            if (nom.equals("") || dni.equals("") || edad.equals("") || direc.equals("") || ape.equals("")) {
                JOptionPane.showMessageDialog(null, "Debe Ingresar Datos");
                limpiarTabla(model);               
            } else {
                String sql =  "INSERT INTO persona(nombres, DNI, edad, direccion, apellido) values('" + nom + "','" + dni + "','" + edad + "','" +direc + "','" + ape + "')";
                con = cn.getConnection();
                st = con.createStatement();
...
void Modificar() {
    ...
    String sql = "update persona set nombres='" + nom + "',DNI='" + dni + "',edad='" + edad + "',direccion='" + direc + "',apellido='" + ape + "' where Id=" + id;
    try {
        if (!nom.isEmpty() && !dni.isEmpty() && !edad.isEmpty() && !direc.isEmpty() && !ape.isEmpty()) {
            con = cn.getConnection();
            st = con.createStatement();
            st.executeUpdate(sql);
